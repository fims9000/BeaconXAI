            ...
            if "beacon_refine" in methods or "beacon_composite" in methods:
                ...
                local_rows.append(
                    LocalMetricRow(
                        ...
                        m0=r_ref.m0,
                        m_last=r_ref.m_last,
                        drop_ratio=r_ref.drop_ratio,
                        residual_ratio=r_ref.residual_ratio,
                        k_checked=r_ref.k_checked,
                        support_mass_removed=r_ref.support_mass_removed,
                        support_mass=r_ref.support_mass,
                        counter_mass=r_ref.counter_mass,
                        counter_ratio=r_ref.counter_ratio,
                        pos_count=r_ref.pos_count,
                        neg_count=r_ref.neg_count,
            ...
            if "beacon_flat" in methods:
                ...
                local_rows.append(
                    LocalMetricRow(
                        ...
                        method="beacon_flat",
                        m0=r_flat.m0,
                        m_last=r_flat.m_last,
                        drop_ratio=r_flat.drop_ratio,
                        residual_ratio=r_flat.residual_ratio,
                        k_checked=r_flat.k_checked,
                        support_mass_removed=r_flat.support_mass_removed,
                        support_mass=r_flat.support_mass,
                        counter_mass=r_flat.counter_mass,
                        counter_ratio=r_flat.counter_ratio,
                        pos_count=r_flat.pos_count,
                        neg_count=r_flat.neg_count,
            ...
            if "uniform_refinement" in methods:
                ...
                local_rows.append(
                    LocalMetricRow(
                        ...
                        m0=r_uni.m0,
                        m_last=r_uni.m_last,
                        drop_ratio=r_uni.drop_ratio,
                        residual_ratio=r_uni.residual_ratio,
                        k_checked=r_uni.k_checked,
                        support_mass_removed=r_uni.support_mass_removed,
                        support_mass=r_uni.support_mass,
                        counter_mass=r_uni.counter_mass,
                        counter_ratio=r_uni.counter_ratio,
                        pos_count=r_uni.pos_count,
                        neg_count=r_uni.neg_count,
