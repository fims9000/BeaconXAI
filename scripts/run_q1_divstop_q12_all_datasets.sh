...
run_dataset() {
...

  {
    ...
    echo "[model] $ROOT/models/${model}_seed1.pkl"
...
run_dataset \
  "har" \
  "$ROOT/data/uci_har_shifted.npz" \
  16 \
  "har_extratrees" \
  "$ROOT/outputs_composite/q1_har_divstop_q12_lam0.5_seeds"

run_dataset \
  "pamap2" \
  "$ROOT/data/pamap2_acc9_w200s100_p095.npz" \
  12 \
  "pamap2_extratrees" \
  "$ROOT/outputs_composite/q1_pamap2_divstop_q12_lam0.5_seeds"

run_dataset \
  "wisdm" \
  "$ROOT/data/wisdm_phone_accel_gyro_w200s100_p90_windowrand42.npz" \
  12 \
  "wisdm_extratrees" \
  "$ROOT/outputs_composite/q1_wisdm_divstop_q12_lam0.5_seeds"
